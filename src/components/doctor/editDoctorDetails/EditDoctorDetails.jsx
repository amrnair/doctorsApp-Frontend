...
const EditDoctorDetails = () => {
    ...
    return (
        <div className='editdoctordetails'>
            <div className='editdoctorimage'><img className='editdoctorprofileimage' src={`https://doctorsapp-backend-empy.onrender.com/`+doctorDetails.profile_image} alt='doctor'></img></div>
