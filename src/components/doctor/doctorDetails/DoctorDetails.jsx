...
const DoctorDetails = () => {
    ...
    return (
        <div className='doctordetails'>
            <div className='doctorimage'><img className='doctorprofileimage' src={`https://doctorsapp-backend-empy.onrender.com/`+doctorDetails.profile_image} alt='doctor'></img></div>
